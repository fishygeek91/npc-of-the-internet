...
### T2.4 ✅ Session loop (Grok 4.5, 2026-07-20)
- Deps: T2.2
...
- Notes: HKDF-SHA-512 session keys via `deriveSessionKey(doorId, epoch)`; `DoorStub` at `test/helpers/door-stub.ts`; integration test `test/session-integration.test.ts`. Next: T2.3 or T2.5.
