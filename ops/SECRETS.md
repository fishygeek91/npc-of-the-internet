...
| `DOOR_HTTP_HOST` / `DOOR_HTTP_PORT` | Door listen address for **both** REST and WebSocket on a single coalesced port (Ghost compose: `0.0.0.0` / `9090`). Not published to the host by default. |
